...
public abstract class Shape implements Comparable<Shape>
{
	...
	{
		// TODO: complete this...
		double comparatorArea = s.getArea();
		double comparatorPerimeter = s.getPerimeter();
		
		
		if(this.getPerimeter() > comparatorPerimeter || this.getArea() > comparatorArea) {
			return 1;
		}
		else if(this.getArea() < comparatorArea || this.getPerimeter() < comparatorPerimeter) {
			return -1;
		}
